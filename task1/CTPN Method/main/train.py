...
tf.flags.DEFINE_integer('max_steps', 50000, '')
...
tf.flags.DEFINE_string('checkpoint_path', 'checkpoints_mlt/', '')
tf.flags.DEFINE_string('logs_path', 'logs_mlt/', '')
tf.flags.DEFINE_string('pretrained_model_path', 'data/vgg_16.ckpt', '')
tf.flags.DEFINE_boolean('restore', False, '')
